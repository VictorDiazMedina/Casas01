...
INSERT INTO `casas`.`usuario` (`user_Nombre`, `user_APaterno`, `user_AMaterno`, `user_WhatsApp`, `user_Password`, `user_Status`, `user_Role`) VALUES ('Admin', 'Admin', 'Admin', '1111111111', '$2y$10$18PzgkzAoN6BbyPMAbBkweus.L1D855HMCOgXREFlw/d3dOYZWT9m', '1', 'admin');
